...
To plot the Z scores against the sample size run the files [plotZscore_vs_N_JetData](plotZscore_vs_N_JetData.py) and [plotZscore_vs_N_MoG](plotZscore_vs_N_MoG.py)
